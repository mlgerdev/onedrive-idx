...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mlgervacio@vqbrx.onmicrosoft.com',
  ...
  protectedRoutes: ['/mlger/Courses', '/🥟 Some test files/Protected route'],
